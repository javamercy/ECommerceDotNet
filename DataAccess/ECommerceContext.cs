        ...
        modelBuilder.Entity<Product>().HasData(
            new List<Product>
            {
                new(1, "iPhone 15 Pro Max",
                    "Apple's flagship iPhone with A17 Pro chip, titanium design, and 48MP camera", 1199,
                    "1.jpg", 75, true),
                new(2, "iPhone 15 Pro", "Premium iPhone with A17 Pro chip, Action button, and titanium design",
                    999, "1.jpg", 85, true),
                new(3, "iPhone 15", "Latest standard iPhone with A16 Bionic chip and Dynamic Island", 799,
                    "1.jpg", 90, true),
                new(4, "iPhone 14 Pro",
                    "Previous generation premium iPhone with A16 Bionic chip and Dynamic Island", 899,
                    "1.jpg", 65, true),
                new(5, "iPhone SE (2022)", "Compact iPhone with A15 Bionic chip and Touch ID", 429,
                    "1.jpg", 100, true),
                new(6, "Samsung Galaxy S24 Ultra",
                    "Samsung's flagship with Snapdragon 8 Gen 3, S Pen, and AI features", 1299,
                    "1.jpg", 55, true),
                new(7, "Samsung Galaxy S24+",
                    "Large display Galaxy with Snapdragon 8 Gen 3 and advanced camera system", 999,
                    "1.jpg", 60, true),
                ...
                new(9, "Samsung Galaxy S23 Ultra",
                    "Previous generation Ultra with Snapdragon 8 Gen 2 and 200MP camera", 1099,
                    "1.jpg", 50, true),
